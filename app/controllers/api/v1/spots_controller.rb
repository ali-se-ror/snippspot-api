module Api
  module V1
    class SpotsController < Api::V1::ApiController
      ...
      def high_ranking_spots
        @spots = Spot.order('spot_rating').limit(3)
      end

      private

      def spot_params
        params.permit(:title, :description, :price, :location, :spot_rating, spot_images: [])
      end
